      ...
      <div className="container">
        <div className="row align-items-center my-5">
          <div className="col-lg-5">
            <img className="img-fluid rounded mb-4 mb-lg-0" src="images/face.jpg" alt="" />
          </div>
          <div className="col-lg-6 text-center text-md-start">
            <h1 className="font-weight-light">Software Engineer | Forever Learner</h1>
        ...
        <div className="align-items-center d-flex flex-column">
          <div className="tech">
            <h2>Tech Stack</h2>
            <p className="icons d-flex flex-row flex-wrap">
          ...
          <div className="fun">
            <h2>Fun</h2>
            <p className="icons d-flex flex-row flex-wrap">
              <img className="family" src="images/family.png" alt="" />
              <img
                className="cycling"
        ...
        <div className="quote">
          <quote>
            "Today I will do what others won't, so tomorrow I can do what others can't." ~ Jerry
            Rice
          </quote>
        </div>
      </div>
